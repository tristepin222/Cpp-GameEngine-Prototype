...
The editor frontend is managed by [EditorUI.cpp](file:///f:/GitHub/Cpp-GameEngine-Prototype/game/src/editor/EditorUI.cpp). It integrates Dear ImGui with Vulkan and GLFW backends.
...
The engine implements a lightweight custom JSON parser and generator inside [TestScene.cpp](file:///f:/GitHub/Cpp-GameEngine-Prototype/game/src/scenes/TestScene.cpp) to save and load scenes:
